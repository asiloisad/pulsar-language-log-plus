...
class LogView {
  ...
  buildElement() {
    ...
    this.regexButton = createElement('button', { className: 'btn' }, [createIcon('language-log-plus-icon-regex')]);
    this.caseSensitiveButton = createElement('button', { className: 'btn' }, [createIcon('language-log-plus-icon-case')]);
  ...
  tail() {
    ...
    return this.textEditor.moveToBottom();
  }
}
