...
class LogView {
  ...
  addTooltips() {
    this.disposables.add(
      ...
      atom.tooltips.add(this.caseSensistiveButton, {
  ...
  handleEvents() {
    this.disposables.add(
      ...
      addListener(this.caseSensistiveButton, 'click', () => this.toggleCaseSensitivity()),
  ...
  handleConfigChanges() {
    this.disposables.add(
      atom.config.onDidChange('language-log-plus.tail', () => {
        this.updateButtons();
        this.tail();
      }),
      atom.config.onDidChange('language-log-plus.caseInsensitive', () => {
        this.updateButtons();
      ...
      atom.config.onDidChange('language-log-plus.useMultiLinesLogEntrySupport', () => {
        this.refreshTextFilter();
      }),
  ...
  toggleTail() {
    return atom.config.set('language-log-plus.tail', !atom.config.get('language-log-plus.tail'));
  }

  toggleCaseSensitivity() {
    return atom.config.set('language-log-plus.caseInsensitive', !atom.config.get('language-log-plus.caseInsensitive'));
  }
